...
<head>
    ...
    <meta content="NM" name="author" />
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ asset('assets/images/logo/logo-sm.png') }}">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                ...
                                </script> Library Managament System. Crafted with <i
    ...
    <script>
        $(document).ready(function() {
            $('#password-addon').click(function() {
                ...
                var eyeIcon = $('#password-addon i');
                eyeIcon.toggleClass('ri-eye-fill ri-eye-off-fill');
            });
        });
    </script>
</body>
