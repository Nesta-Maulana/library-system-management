<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="{{ url('/') }}" class="logo logo-dark">
            <span class="logo-sm">
                <img src="/assets/images/logo/logo-sm.png" alt="" height="60">
            </span>
            <span class="logo-lg">
                <!-- <img src="/assets/images/logo/logo-logo-sm.png" alt="" height="17"> -->
                <img src="/assets/images/logo/logo-sm.png" alt="" height="30">
            </span>
        </a>
        <!-- Light Logo-->
